...
DEFAULT_METERED_EVENTS = [
    ...
    # Core Business OS metered events
    {
        "event_key": "action_created",
        "display_name": "Action Created",
        "description": "Proposed action created in Action Center",
        "unit_name": "record",
        "credits_per_unit": 0.2,
        "list_price_per_credit": 0.02,
        "billable": 1,
    ...
    {
        "event_key": "action_updated",
        "display_name": "Action Updated",
        "description": "Action record updated",
        "unit_name": "record",
    ...
    {
        "event_key": "action_approved",
        "display_name": "Action Approved",
        "description": "Action approved by admin",
        "unit_name": "event",
        "credits_per_unit": 0.2,
        "list_price_per_credit": 0.02,
        "billable": 1,
    ...
    {
        "event_key": "action_rejected",
        "display_name": "Action Rejected",
        "description": "Action rejected by admin",
        "unit_name": "event",
        "credits_per_unit": 0.1,
        "list_price_per_credit": 0.02,
        "billable": 1,
    ...
    {
        "event_key": "action_executed",
        "display_name": "Action Executed",
        "description": "Action executed (stub)",
        "unit_name": "event",
    ...
    },
    {
        ...
        "description": "Task created in Work OS",
        "unit_name": "record",
        "credits_per_unit": 0.1,
        "list_price_per_credit": 0.02,
        "billable": 1,
    ...
    {
        "event_key": "decision_created",
        "display_name": "Decision Created",
    ...
    {
        "event_key": "decision_updated",
        "display_name": "Decision Updated",
    ...
    {
        "event_key": "meeting_note_created",
        "display_name": "Meeting Note Created",
    ...
    {
        "event_key": "meeting_note_updated",
        "display_name": "Meeting Note Updated",
    ...
    {
        "event_key": "memory_fact_created",
        "display_name": "Memory Fact Created",
        "description": "Governed memory fact created",
        "unit_name": "record",
        "credits_per_unit": 0.2,
        "list_price_per_credit": 0.02,
        "billable": 1,
    ...
    {
        "event_key": "memory_fact_updated",
        "display_name": "Memory Fact Updated",
        "description": "Governed memory fact updated",
        "unit_name": "record",
        "credits_per_unit": 0.1,
        "list_price_per_credit": 0.02,
        "billable": 1,
    ...
    {
        "event_key": "memory_fact_superseded",
        "display_name": "Memory Fact Superseded",
        "description": "Governed memory fact superseded with new version",
        "unit_name": "event",
        "credits_per_unit": 0.1,
        "list_price_per_credit": 0.02,
        "billable": 1,
    ...
    {
        "event_key": "evidence_link_created",
        "display_name": "Evidence Link Created",
        "description": "Evidence/provenance link created",
        "unit_name": "record",
        "credits_per_unit": 0.05,
        "list_price_per_credit": 0.02,
        "billable": 1,
    ...
    {
        "event_key": "search_query",
        "display_name": "Search Query",
        "description": "Global search query executed",
        "unit_name": "call",
        "credits_per_unit": 0.05,
        "list_price_per_credit": 0.02,
        "billable": 1,
...
DEFAULT_CAPABILITIES = [
    ...
    # Core Business OS capabilities
    {"capability_key": "action_center", "description": "Access to Action Center for proposed actions"},
    {"capability_key": "tasks", "description": "Access to Tasks in Work OS"},
    {"capability_key": "decisions", "description": "Access to Decisions log"},
    {"capability_key": "meetings", "description": "Access to Meeting notes"},
    {"capability_key": "memory", "description": "Access to Governed Memory (facts)"},
    {"capability_key": "timeline", "description": "Access to Unified Timeline"},
    {"capability_key": "search", "description": "Access to Global Search"},
]
...
# All capabilities
ALL_CAPABILITIES = [
    "chat", "tools", "briefs", "notifications", "kpi_ingest", "kpi_read",
    "action_center", "tasks", "decisions", "meetings", "memory", "timeline", "search"
]
